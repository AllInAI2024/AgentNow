...
from sqlalchemy import Column, BigInteger, String, DateTime, Integer, SmallInteger, Index
...
class Department(Base):
    ...
    parent_id = Column(BigInteger, default=0, comment="父部门ID（0表示顶级部门）")
    ...
    leader_id = Column(BigInteger, comment="部门负责人ID（关联用户表）")
